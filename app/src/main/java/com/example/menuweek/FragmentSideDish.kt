...
class FragmentSideDish : Fragment() {
    ...
    override fun onCreateView(
        ...
        val binding = FragmentSideDishBinding.inflate(layoutInflater)
        binding.lifecycleOwner = this
        binding.viewModel = viewModel
        binding.viewModelOrder = viewModelOrder
        binding.next.setOnClickListener {
            findNavController().navigate(R.id.action_fragmentSideDish_to_fragmentDesert)
        }
        binding.cancel.setOnClickListener {
            viewModelOrder.resetOrder()
            findNavController().navigate(R.id.action_fragmentSideDish_to_fragmentStart)
        }
        return binding.root
    }
