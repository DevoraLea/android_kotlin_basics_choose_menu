...
import com.example.menuweek.databinding.FragmentAccompanimentBinding
...
class FragmentAccompaniment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val binding = FragmentAccompanimentBinding.inflate(layoutInflater)
        binding.lifecycleOwner = this
        binding.viewModel = viewModel
        binding.viewModelOrder = viewModelOrder
        binding.next.setOnClickListener {
            findNavController().navigate(R.id.action_fragmentAccompaniment_to_fragmentSideDish)
        }
        binding.cancel.setOnClickListener {
            viewModelOrder.resetOrder()
            findNavController().navigate(R.id.action_fragmentAccompaniment_to_fragmentStart)
        }
        return binding.root
    }
